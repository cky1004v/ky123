...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "일자리 회원 신청" },
      { property: "og:description", content: BRAND.tagline },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { title: "일자리 회원 신청" },
      { property: "og:title", content: "일자리 회원 신청" },
      { name: "twitter:title", content: "일자리 회원 신청" },
      { name: "description", content: "일자리 회원 신청 관리 서비스로, 누구나 쉽게 신청하고 관리자는 효율적으로 회원 관리를 할 수 있습니다." },
      { property: "og:description", content: "일자리 회원 신청 관리 서비스로, 누구나 쉽게 신청하고 관리자는 효율적으로 회원 관리를 할 수 있습니다." },
      { name: "twitter:description", content: "일자리 회원 신청 관리 서비스로, 누구나 쉽게 신청하고 관리자는 효율적으로 회원 관리를 할 수 있습니다." },
